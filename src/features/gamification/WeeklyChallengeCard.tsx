...
export default function WeeklyChallengeCard() {
  ...
  return (
    <View className="bg-slate-900 rounded-2xl p-5 w-full">
      <Text className="text-slate-100 text-base font-semibold mb-1">This Week</Text>
      ...
      <Text className="text-slate-300 text-sm">{completedThisWeek} of {WEEKLY_TASK_GOAL} tasks completed</Text>
    </View>
  );
}
