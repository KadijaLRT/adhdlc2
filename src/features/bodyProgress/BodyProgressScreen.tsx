    ...
    <ScrollView className="flex-1" contentContainerStyle={{ padding: 20 }}>
      <View className="w-full max-w-md self-center">
        ...
        <View className="bg-slate-900 rounded-2xl p-4 mb-4">
          <Text className="text-slate-300 text-sm font-medium mb-3">Weight trend</Text>
          <View className="flex-row flex-wrap gap-3 mb-3">
            ...
            <View className="flex-1 min-w-[45%]">
              <Text className={thirtyDayChange !== null && thirtyDayChange < 0 ? 'text-emerald-400 text-xl font-bold' : 'text-slate-200 text-xl font-bold'}>
            ...
            <View className="flex-1 min-w-[45%]">
              <Text className="text-slate-200 text-xl font-bold">{goalDate || '—'}</Text>
          ...
          <View className="flex-row gap-2">
            <TextInput
              ...
              className="flex-1 bg-slate-800 text-slate-100 rounded-xl px-3 py-2"
            />
            <Pressable onPress={handleSaveGoal} className="bg-slate-800 rounded-xl px-4 justify-center">
              <Text className="text-slate-300 text-sm font-medium">Set goal</Text>
            </Pressable>
          </View>
        </View>

        <View className="bg-slate-900 rounded-2xl p-4 mb-4">
          <Text className="text-slate-300 text-sm font-medium mb-2">Body measurements</Text>
            ...
            {(MEASUREMENT_SITES || []).map((site) => {
              ...
              return (
                <Pressable
                  ...
                  className={isActive ? 'bg-indigo-600/20 border-2 border-indigo-400 rounded-xl p-2 items-center w-[30%]' : 'bg-slate-800 border-2 border-transparent rounded-xl p-2 items-center w-[30%]'}
                >
                  <Text className={isActive ? 'text-indigo-200 text-xs' : 'text-slate-300 text-xs'}>{site.label}</Text>
        ...
        <Text className="text-slate-100 text-lg font-semibold mb-3">Milestones</Text>
...
function MilestoneRow({ label, achieved }: { label: string; achieved: boolean }) {
  return (
    <View className="bg-slate-900 rounded-xl p-3 flex-row items-center gap-2">
